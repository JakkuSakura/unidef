...
from unidef.utils.transformer import NodeTransformer, FuncNodeTransformer
        ...
        for key in dir(self):
            if key.startswith(prefix):
                ...
                if isinstance(value, Callable):
                    ...
                    functions.append(FuncNodeTransformer(target_name=node_name, func=value, acceptor=acceptor))
